...
Brondata van geometrieën voor de DSO-LV wordt volgens de uitgangsarchitectuur aangeleverd in ETRS89 of RD. De geometrieën worden *'as is'* getransformeerd voor dubbele opslag in RD en ETRS89. De bronhouder is verantwoordelijk voor toepassing van het langelijnenadvies. Geometrieën worden via een API uitgewisseld in RD, ETRS89 en WGS 84 Web-Mercator. Voor de transformatie tussen ETRS89 en WGS 84 wordt een [nultransformatie](#wgs-84-gelijkstellen-aan-etrs89-nultransformatie) gebruikt. In de viewer wordt altijd de RD-kaartprojectie gebruikt en kan de gebruiker kiezen tussen het weergeven van RD of ETRS89 coördinaten. Overigens is bij de implementatie van de DSO-LV uieindelijk niet gekozen voor dubbele opslag, maar wordt een vergelijkbare strategie toegepast als bij het voorbeeld van de BRO en enkele opslag in RD.
