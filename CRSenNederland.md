...
Het International Terrestrial Reference System geeft de definities om een wereldwijd CRS te kunnen realiseren; een ITRF is een realisatie hiervan. ITRS wordt onderhouden door de IERS (International Earth Rotation Service). Het gebruik van International Terrestrial Reference Frame (ITRF) als wereldwijd CRS wordt door resoluties van de International Union of Geodesy and Geophysics (IUGG, [resolutie 2 van 2019](https://iugg.org/wp-content/uploads/2022/03/2019-IUGG-GA-Resolutions.pdf#page=2)) en de Verenigde Naties ([VN-resolutie A/RES/69/266](https://undocs.org/en/A/RES/69/266)) aangeraden voor plaatsbepaling, satellietnavigatie, toepassingen van aardwetenschappen en de vastlegging van nationale en regionale CRS-en. Voor eenduidige coördinaten is het van belang om naast de realisatie ook het tijdstip (epoche) te vermelden. Om data in ITRF te visualiseren worden kaartprojecties gekozen die geschikt zijn voor de beoogde toepassing.
...
Van het [EVRS](http://www.euref.eu/egrs) bestaan inmiddels drie realisaties, EVRF2000, EVRF2007 en EVRF2019. EVRF2007 is opgenomen in de INSPIRE richtlijnen als 1D CRS voor geharmoniseerde uitwisseling van hoogte gegevens.
