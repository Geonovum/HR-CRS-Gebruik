...
Brondata van geometrieën voor de DSO-LV wordt aangeleverd in ETRS89 of RD. Binnen de DSO-LV worden de geometrieën *'as is'* getransformeerd voor dubbele opslag in RD en ETRS89. De bronhouder is verantwoordelijk voor toepassing van het langelijnenadvies. Geometrieën worden via een API uitgewisseld in RD en ETRS89. Voor visualisatie wordt RD als kaartprojectie gebruikt en optioneel WGS 84 Web-Mercator. Voor de transformatie tussen ETRS89 en WGS 84 wordt een nultransformatie gebruikt. In de viewer van DSO-LV wordt altijd de RD-kaartprojectie gebruikt en kan de gebruiker kiezen tussen het weergeven van RD of ETRS89 coördinaten.
